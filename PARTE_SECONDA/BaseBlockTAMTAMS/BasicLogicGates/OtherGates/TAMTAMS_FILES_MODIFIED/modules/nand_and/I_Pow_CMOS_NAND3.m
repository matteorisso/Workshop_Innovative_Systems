%% CMOS NAND 3 POWER ANALYSIS
% Implementation of a model for the evaluation of power consumption of 3 inputs CMOS NAND-AND gates
%%
...
% Module name: I_Pow_CMOS_nand3.m
% Stored informations:  Inand3_cmos_btb, Inand3_cmos_gate, Inand3_cmos_off, Pnand3,  Pnand3_dyn
...
Ibtb_n_cmos3=Ibtb_nmos.*Wn;    		% nA  		
Ibtb1_n_cmos3=Ibtb_nmos_1.*Wn;    	% nA
Ibtb1_2_n_cmos3=Ibtb_nmos_1_2.*Wn;   	% nA
Ibtb1_3_n_cmos3=Ibtb_nmos_1_3.*Wn;   	% nA
Ibtb2_3_n_cmos3=Ibtb_nmos_2_3.*Wn;   	% nA
Ibtb_p_cmos3=Ibtb_pmos.*Wp;      	% nA

I_0_0_0=Ibtb_n_cmos3+Ibtb2_3_n_cmos3+Ibtb1_3_n_cmos3;	% nA
I_0_0_1=Ibtb_n_cmos3+Ibtb1_2_n_cmos3;			% nA
I_0_1_0=Ibtb_n_cmos3+2.*Ibtb1_2_n_cmos3;		% nA
% Because the second transistor is like a short circuit
I_0_1_1=Ibtb_n_cmos3;					% nA
I_1_0_0=Ibtb_n_cmos3+Ibtb1_n_cmos3+Ibtb1_2_n_cmos3;	% nA
% Because the first transistor is like a short circuit
I_1_0_1=Ibtb_n_cmos3+Ibtb1_n_cmos3;			% nA
I_1_1_0=Ibtb_n_cmos3+2.*Ibtb1_n_cmos3;			% nA
% Because both the first transistor both the second one are like short circuit
I_1_1_1=3.*Ibtb_p_cmos3;				% nA

Inand3_cmos_btb(counter_mod_index, counter_tech_index, i)=(I_0_0_0+I_0_0_1+I_0_1_0+I_0_1_1+I_1_0_0+I_1_0_1+I_1_1_0+I_1_1_1)./8;	% nA   

Ibtb_nand_and(counter_mod_index, counter_tech_index,i)=Inand3_cmos_btb(counter_mod_index, counter_tech_index,i);

MULTIVDD=[Vdd(counter_tech_index), VDD2]; % V 
% Power supply Vector

Pnand3_btb(counter_mod_index,counter_tech_index,i)=0;

for j=1:length(MULTIVDD)
		Pnand3_btb(counter_mod_index,counter_tech_index,i)=Pnand3_btb(counter_mod_index,counter_tech_index,i)+Inand3_cmos_btb(counter_mod_index,counter_tech_index,i).*MULTIVDD(j).*1e-9; % W
...
Igate_n_cmos3=Igate_nmos.*Wn;    % nA
Igate_p_cmos3=Igate_pmos.*Wp;    % nA

I_0_0_0=3.*Igate_p_cmos3;		% nA
I_0_0_1=Igate_n_cmos3+2.*Igate_p_cmos3;	% nA
I_0_1_0=2.*Igate_p_cmos3;		% nA
I_0_1_1=2.*Igate_n_cmos3+Igate_p_cmos3;	% nA
I_1_0_0=2.*Igate_p_cmos3;		% nA
I_1_0_1=Igate_n_cmos3+Igate_p_cmos3;	% nA
I_1_1_0=Igate_p_cmos3;			% nA
I_1_1_1=3.*Igate_n_cmos3;		% nA

Inand3_cmos_gate(counter_mod_index, counter_tech_index, i)=(I_0_0_0+I_0_0_1+I_0_1_0+I_0_1_1+I_1_0_0+I_1_0_1+I_1_1_0+I_1_1_1)./8;	% nA   

Igate_nand_and(counter_mod_index, counter_tech_index,i)=Inand3_cmos_gate(counter_mod_index, counter_tech_index,i) ;

MULTIVDD=[Vdd(counter_tech_index), VDD2]; % V 
% Power supply Vector

Pnand3_gate(counter_mod_index,counter_tech_index,i)=0;

for j=1:length(MULTIVDD)
		Pnand3_gate(counter_mod_index,counter_tech_index,i)=Pnand3_gate(counter_mod_index,counter_tech_index,i)+Inand3_cmos_gate(counter_mod_index,counter_tech_index,i).*MULTIVDD(j).*1e-9; % W
...
Ioff_n_cmos3=Ioff_nmos_1.*Wn;      % nA
Ioff2_n_cmos3=Ioff_nmos_2.*Wn;   % nA
Ioff3_n_cmos3=Ioff_nmos_3.*Wn;   % nA
Ioff_p_cmos3=Ioff_pmos.*Wp;      % nA

I_0_0_0=Ioff3_n_cmos3;			% nA
I_0_0_1=Ioff2_n_cmos3;			% nA
I_0_1_0=Ioff2_n_cmos3;			% nA
I_0_1_1=Ioff_n_cmos3;			% nA
I_1_0_0=Ioff2_n_cmos3;			% nA
I_1_0_1=Ioff_n_cmos3;			% nA
I_1_1_0=Ioff_n_cmos3;			% nA
I_1_1_1=3.*Ioff_p_cmos3;		% nA

Inand3_cmos_off(counter_mod_index, counter_tech_index, i)=(I_0_0_0+I_0_0_1+I_0_1_0+I_0_1_1+I_1_0_0+I_1_0_1+I_1_1_0+I_1_1_1)./8;	% nA   

Ioff_nand_and(counter_mod_index, counter_tech_index,i)=Inand3_cmos_off(counter_mod_index, counter_tech_index,i);

MULTIVDD=[Vdd(counter_tech_index), VDD2]; % V 
% Power supply Vector

Pnand3_off(counter_mod_index,counter_tech_index,i)=0;

for j=1:length(MULTIVDD)
		Pnand3_off(counter_mod_index,counter_tech_index,i)=Pnand3_off(counter_mod_index,counter_tech_index,i)+Inand3_cmos_off(counter_mod_index,counter_tech_index,i).*MULTIVDD(j).*1e-9; % W 

endfor

endfor

% POWER STATIC CMOS nand3 

% Vdd_d is the distribution of Vdd in multi-supply voltage chip
% Vdd_d and VDD2 ---> datibase.m

Pnand3(counter_mod_index,counter_tech_index,:)=Pnand3_off(counter_mod_index,counter_tech_index,:)+Pnand3_gate(counter_mod_index,counter_tech_index,:)+Pnand3_btb(counter_mod_index,counter_tech_index,:); % W

Pnand_and(counter_mod_index,counter_tech_index,:)=Pnand3(counter_mod_index,counter_tech_index,:);


% POWER DYNAMIC CMOS NAND3 

for i=1:4

	Pnand3_dyn(counter_mod_index,counter_tech_index,i)=0;
	for j=1:length(MULTIVDD)
			Pnand3_dyn(counter_mod_index,counter_tech_index,i)=Pnand3_dyn(counter_mod_index,counter_tech_index,i)+(Cnand3_cmos(counter_mod_index,counter_tech_index,i).*1e-12).*Vdd_d(j).*MULTIVDD(j).^2.*freq(counter_mod_index,counter_tech_index).*1e6; % W 
	endfor

endfor

Pnand_and_dyn(counter_mod_index,counter_tech_index,:)=Pnand3_dyn(counter_mod_index,counter_tech_index,:);
