...
$nbulk     =3.68e18;  //cm^-3        Channel Doping (w/o Pockets)             
...
$rconst_n  =229.64;    //Ohm        These values are simply the result from a fitting of Mastar's outputs. 
$rconst_p  =229.64;    //Ohm     NON SICURO: Ho usato lo stesso valore di rconst_n   We need to have a more accurate model for resist)ance (Kim's one in Mastar
$x         =0; /// CHE COSA E'?
...
$phi_s     =1.874; // ricavato dal file phi_compute.m        
