...
$tox       =0.5;       //nm            Physical Gate Oxide Thickness 
$nbulk     =8.08e18;  //cm^-3        Channel Doping (w/o Pockets)             
...
$darks     =2.5;         //[Å = 0.1nm]  Extension of the Dark Space (in EOT). 
...
$rconst_n  =263.62;    //Ohm        These values are simply the result from a fitting of Mastar's outputs. 
$rconst_p  =263.62;    //Ohm     NON SICURO: stesso valore di rconst_n   We need to have a more accurate model for resist)ance (Kim's one in Mastar
$x         =0; /// CHE COSA E'?
