...
$tox       =0.75;       //nm            Physical Gate Oxide Thickness 
$nbulk     =6.33e18;  //cm^-3        Channel Doping (w/o Pockets)             
...
$darks     =2.8;         //[Å = 0.1nm]  Extension of the Dark Space (in EOT). 
...
$rconst_n  =249.1;    //Ohm        These values are simply the result from a fitting of Mastar's outputs. 
$rconst_p  =249.1;    //Ohm     NON SICURO: Ho usato lo stesso valore di rconst_n   We need to have a more accurate model for resist)ance (Kim's one in Mastar
$x         =0; /// CHE COSA E'?
...
$phi_s     =1.879; // ricavato dal file phi_compute.m       
