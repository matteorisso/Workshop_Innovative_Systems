...
$ldraw     =35;        // NON SICUR0: non trovato in MASTAR 
$tox       =0.65;       //nm           Physical Gate Oxide Thickness 
$nbulk     =7.14e18;  //cm^-3        Channel Doping (w/o Pockets)             
...
$darks     =2.7;         //[Å = 0.1nm]  Extension of the Dark Space (in EOT). 
...
$rconst_n  =254.61;    //Ohm        These values are simply the result from a fitting of Mastar's outputs. 
$rconst_p  =254.61;    // NON SICUR0: stesso valore di rconst_n Ohm        We need to have a more accurate model for resist)ance (Kim's one in Mastar
...
$wt        =1000;      //nm           Width       
$phi_m     =4.15;      //eV          lavoro estrazione polisilicio little bit higher than 4.05 because polysilicon is highly doped; (NON é lo stesso PER NMOS e PMOS)!!!!				4.55 originally, modified in 4.25 has in the previous files  
...
$fring_cap =1.5e-16;   //F/um
$gamma     =0.7;       //             Scaling Factor for the Lateral Diffusion: Lelec=Lgate-gamma*Xj    
$phi_s     =1.883; // ricavato dal file phi_compute.m     
$zeta      =0.8;       //             Scaling Factor for the DIBL (Drain Induced Barrier Lowering) 
$kappa     =79; 		// NON SICUR0: non trovato in MASTAR
...
$sigma     =1;  	// NON SICUR0: non trovato in MASTAR: valore di HP_2007
$ig_improve=1;      // NON SICUR0: non trovato in MASTAR: valore di HP_2007
