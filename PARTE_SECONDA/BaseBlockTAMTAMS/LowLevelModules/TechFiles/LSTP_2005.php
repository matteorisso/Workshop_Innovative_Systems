...
$model     =0;         //BULK         Type
$year      =2005;      //             Year
$lgate     =65;        //nm           Physical Gate Length 
...
$ldraw     =35;        // NON SICURO: stesso valore di LSTP_2007
$tox       =2.1;       //nm           Physical Gate Oxide Thickness 
$nbulk     =2.32e18;  //cm^-3        Channel Doping (w/o Pockets)             
$nd        =1e20;      // NON SICURO: valore di Ngp di MASTAR cm^-3        drogaggio polisilicio n+  
$next	   =7.819e18;// NON SICUR0: valore di HP_2007 cm^-3	  extensions doping  
$nc        =1e20;      // NON SICURO: valore di Ngp di MASTAR cm^-3        source/drain doping - non sono sicuro che il valore sia corretto
$xj        =28;        //nm
$vdd       =1.2;       //V            Operation Voltage (Gate and Drain Voltage) 
$darks     =3.6;         //[Å = 0.1nm]  Extension of the Dark Space (in EOT). 
$polyd     =2.7;         //[Å = 0.1nm]  Extension of the poly-depletion (in EOT)
...
$rconst_n  =193.22;    //Ohm        These values are simply the result from a fitting of Mastar's outputs. 
$rconst_p  =193.22;    // NON SICURO: stesso valore di rconst_n Ohm        We need to have a more accurate model for resist)ance (Kim's one in Mastar

$tbox	   =20; 		//nm Buried Oxide Thickness
$tsi        =7.6;        //nm
$ngp	   =1e20; 		//cm^-3 Ground Plain doping level

$x         =0;	// NON SICURO: stesso valore di LSTP_2007
$cpoches   =5.2e13;    //at/cm²
$angle     =25;        //°            Pocket Implantation Angle 
$rp        =10;        // NON SICURO: stesso valore di LSTP_2007 nm
$delta_rp  =6;         // NON SICURO: stesso valore di LSTP_2007 nm
$delta_rl  =3;         // NON SICURO: stesso valore di LSTP_2007 nm
$activepkt =0;		   // NON SICURO: stesso valore di LSTP_2007 
$wt        =1000;      //nm           Width       
$phi_m     =4.05;      //eV          lavoro estrazione polisilicio little bit higher than 4.05 because polysilicon is highly doped; (NON é lo stesso PER NMOS e PMOS)!!!!		// 4.05 originally, modified in 4.12 has in the previous files  
...
$phi_s     =1.838; 		// valore calcolato con phi_compute.m       
...
$sigma     =1; // NON SICURO: stesso valore di LSTP_2007 
$ig_improve=0; // NON SICURO: stesso valore di LSTP_2007 
