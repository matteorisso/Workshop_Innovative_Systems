...
$model     =0;         //BULK         Type
$year      =2006;      //             Year
$lgate     =53;        //nm           Physical Gate Length 
...
$tox       =2;       //nm           Physical Gate Oxide Thickness 
$nbulk     =3.22e18;  //cm^-3        Channel Doping (w/o Pockets)             
...
$darks     =3.5;         //[Å = 0.1nm]  Extension of the Dark Space (in EOT). 
$polyd     =2.8;         //[Å = 0.1nm]  Extension of the poly-depletion (in EOT)
...
$rconst_n  =193.75;    //Ohm        These values are simply the result from a fitting of Mastar's outputs. 
$rconst_p  =193.75;    // NON SICURO: stesso valore di rconst_n Ohm        We need to have a more accurate model for resist)ance (Kim's one in Mastar
...
$phi_s     =1.852; 		// valore calcolato con phi_compute.m         
