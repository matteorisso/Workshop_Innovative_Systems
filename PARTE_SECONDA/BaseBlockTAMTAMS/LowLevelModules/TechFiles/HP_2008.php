...
$nbulk     =5.05e18;  //cm^-3        Channel Doping (w/o Pockets)             
...
$xj        =7.5;        //nm
$vdd       =1.0;       //V            Operation Voltage (Gate and Drain Voltage) 
$darks     =2.9;         //[Å = 0.1nm]  Extension of the Dark Space (in EOT). 
$polyd     =0.0;         //[Å = 0.1nm]  Extension of the poly-depletion (in EOT)
...
$rconst_n  =242.79;    //Ohm        These values are simply the result from a fitting of Mastar's outputs. 
$rconst_p  =242.79;    //Ohm     NON SICURO: Ho usato lo stesso valore di rconst_n   We need to have a more accurate model for resist)ance (Kim's one in Mastar
$x         =0; /// CHE COSA E'?
...
$wt        =1000;      //nm           Width       
$phi_m     =4.15;      // NON SICURO: valore di mastar 4.05eV          lavoro estrazione polisilicio little bit higher than 4.05 because polysilicon is highly doped; (NON é lo stesso PER NMOS e PMOS)!!!!	
...
// I valori seguenti sono NON SICURI: lasciati i corrispondenti valori di hp_2007 non avendoli trovati
