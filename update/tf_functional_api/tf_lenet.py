...
#TRAINING PIPELINE
EPOCHS      = 5     # number of iterations on the entire dataset
...
with tf.variable_scope('Train'):
    ...
    with tf.variable_scope('Optimizer'):
        ...
        #• ? • GradientDescentOptimizer @11-13%  
...
with tf.Session() as sess:
    saver = tf.train.import_meta_graph('./tf_lenet.meta')    
    saver.restore(sess, "./tf_lenet")
