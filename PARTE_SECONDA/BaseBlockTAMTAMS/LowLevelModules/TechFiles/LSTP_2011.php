...
$nbulk     =5.86e18;  //cm^-3        Channel Doping (w/o Pockets)             
...
$rconst_n  =223.76;    //Ohm        These values are simply the result from a fitting of Mastar's outputs. 
$rconst_p  =223.76;    // NON SICURO: stesso valore di rconst_n Ohm        We need to have a more accurate model for resist)ance (Kim's one in Mastar
...
$wt        =1000;      //nm           Width       
$phi_m     =4.15;      //eV          lavoro estrazione polisilicio little bit higher than 4.05 because polysilicon is highly doped; (NON é lo stesso PER NMOS e PMOS)!!!!		// 4.05 originally, modified in 4.12 has in the previous files  
...
$fring_cap =1.8e-16;   //F/um
$gamma     =0.75;       //             Scaling Factor for the Lateral Diffusion: Lelec=Lgate-gamma*Xj  
$phi_s     =1.922; 		// valore calcolato con phi_compute.m        
