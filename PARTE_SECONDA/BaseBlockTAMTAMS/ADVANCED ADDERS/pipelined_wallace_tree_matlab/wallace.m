% Wallace tree design
% Note: lines 44, 45, 46, 89 generate FidoCadJ code.
% Lines 49, 52, 62, 80, 83, 95 generate VHDL code.
close all
clear all

% Inputs parameters
n=128;    % number of input bits
k=128;    % number of operands
radix=1; % radix of the multiplier usign the wallace tree to sum partial products
ppipe=1; % every how many levels of the tree a pipe stage is introduced
ND2area=0.5e-12; % m^2
Wn=0.27e-6; % m
