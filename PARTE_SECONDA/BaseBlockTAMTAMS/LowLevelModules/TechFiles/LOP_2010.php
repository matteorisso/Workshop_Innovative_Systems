...
$tox       =0.9;       //nm           Physical Gate Oxide Thickness 
$nbulk     =4.87e18;  //cm^-3        Channel Doping (w/o Pockets)             
...
$rconst_n  =193.39;    //Ohm        These values are simply the result from a fitting of Mastar's outputs. 
$rconst_p  =193.39;    // NON SICUR0: stesso valore di rconst_n Ohm        We need to have a more accurate model for resist)ance (Kim's one in Mastar
...
$wt        =1000;      //nm           Width       
$phi_m     =4.15;      //eV          lavoro estrazione polisilicio little bit higher than 4.05 because polysilicon is highly doped; (NON é lo stesso PER NMOS e PMOS)!!!!		4.25 originally, modified in 4.15 has in the previous files  
