...
C_X = const*Cjn; %pF
C_tot=C_in*(alfa_a+alfa_b)+C_M*alfa_M+C_X*alfa_x;  %pF     % tiene già conto della switching activity
...
%---STATIC POWER
static_power = Vdd*0.25*(2*Ioff_pmos+4*Igate_pmos+6*Ioff_nmos+6*Igate_nmos)*1e-9;	%W
