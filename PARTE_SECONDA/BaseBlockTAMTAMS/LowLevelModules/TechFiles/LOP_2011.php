...
$rconst_n  =222.04;    //Ohm        These values are simply the result from a fitting of Mastar's outputs. 
$rconst_p  =222.04;    // NON SICURO: stesso valore di rconst_n Ohm        We need to have a more accurate model for resist)ance (Kim's one in Mastar
...
$phi_s	   =1.88;     // valore calcolato con phi_compute.m       
