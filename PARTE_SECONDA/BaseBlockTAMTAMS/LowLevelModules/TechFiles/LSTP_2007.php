...
$model     =0;         //BULK         Type
$year      =2007;      //             Year
$lgate     =45;        //nm           Physical Gate Length 
...
$tox       =1.9;       //nm           Physical Gate Oxide Thickness 
$nbulk     =3.96e18;  //cm^-3        Channel Doping (w/o Pockets)             
...
$darks     =3.4;         //[Å = 0.1nm]  Extension of the Dark Space (in EOT). 
$polyd     =2.9;         //[Å = 0.1nm]  Extension of the poly-depletion (in EOT)
...
$rconst_n  =197.89;    //Ohm        These values are simply the result from a fitting of Mastar's outputs. 
$rconst_p  =197.89;    // NON SICUR0: valore di rconst_n Ohm        We need to have a more accurate model for resist)ance (Kim's one in Mastar
...
$phi_s     =1.858; 		// valore calcolato con phi_compute.m       
...
$ig_improve=0; // NON SICUR0: valore precedente
