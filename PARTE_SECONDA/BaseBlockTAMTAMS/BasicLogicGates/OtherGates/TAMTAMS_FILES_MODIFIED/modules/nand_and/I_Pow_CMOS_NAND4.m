%% CMOS NAND 4 POWER ANALYSIS
% Implementation of a model for the evaluation of power consumption of 4 inputs CMOS NAND-AND gates
%%
...
% Module name: I_Pow_CMOS_nand4.m
% Stored informations:  Inand4_cmos_btb, Inand4_cmos_gate, Inand4_cmos_off, Pnand4,  Pnand4_dyn
...
Ibtb_n_cmos4=Ibtb_nmos.*Wn;   		% nA
Ibtb1_n_cmos4=Ibtb_nmos_1.*Wn;   	% nA
Ibtb1_2_n_cmos4=Ibtb_nmos_1_2.*Wn;   	% nA
Ibtb1_3_n_cmos4=Ibtb_nmos_1_3.*Wn;   	% nA
Ibtb2_3_n_cmos4=Ibtb_nmos_2_3.*Wn;   	% nA
Ibtb1_4_n_cmos4=Ibtb_nmos_1_4.*Wn;   	% nA
Ibtb3_4_n_cmos4=Ibtb_nmos_3_4.*Wn;  	% nA
Ibtb_p_cmos4=Ibtb_pmos.*Wp;      	% nA
  		
I_0_0_0_0=Ibtb_n_cmos4+Ibtb3_4_n_cmos4+Ibtb1_2_n_cmos4+Ibtb1_4_n_cmos4;	% nA
I_0_0_0_1=Ibtb_n_cmos4+Ibtb2_3_n_cmos4+Ibtb1_3_n_cmos4;			% nA
I_0_0_1_0=Ibtb_n_cmos4+Ibtb2_3_n_cmos4+2.*Ibtb1_3_n_cmos4;		% nA
I_0_0_1_1=Ibtb_n_cmos4+Ibtb1_2_n_cmos4;					% nA
I_0_1_0_0=Ibtb_n_cmos4+2.*Ibtb2_3_n_cmos4+Ibtb1_3_n_cmos4;		% nA
I_0_1_0_1=Ibtb_n_cmos4+2.*Ibtb1_2_n_cmos4;				% nA
I_0_1_1_0=Ibtb_n_cmos4+3.*Ibtb1_2_n_cmos4;				% nA
I_0_1_1_1=Ibtb_n_cmos4;							% nA
I_1_0_0_0=Ibtb_n_cmos4+Ibtb1_n_cmos4+Ibtb2_3_n_cmos4+Ibtb1_3_n_cmos4;	% nA
I_1_0_0_1=Ibtb_n_cmos4+Ibtb1_n_cmos4+Ibtb1_2_n_cmos4;			% nA
I_1_0_1_0=Ibtb_n_cmos4+Ibtb1_n_cmos4+2.*Ibtb1_2_n_cmos4;		% nA
I_1_0_1_1=Ibtb_n_cmos4+Ibtb1_n_cmos4;					% nA
I_1_1_0_0=Ibtb_n_cmos4+2.*Ibtb1_n_cmos4+Ibtb1_2_n_cmos4;		% nA
I_1_1_0_1=Ibtb_n_cmos4+2.*Ibtb1_n_cmos4;				% nA
I_1_1_1_0=Ibtb_n_cmos4+3.*Ibtb1_n_cmos4;				% nA
I_1_1_1_1=4.*Ibtb_p_cmos4;						% nA

Inand4_cmos_btb(counter_mod_index, counter_tech_index, i)=(I_0_0_0_0+I_0_0_0_1+I_0_0_1_0+I_0_0_1_1+I_0_1_0_0+I_0_1_0_1+I_0_1_1_0+I_0_1_1_1+I_1_0_0_0+I_1_0_0_1+I_1_0_1_0+I_1_0_1_0+I_1_0_1_1+I_1_1_0_0+I_1_1_0_1+I_1_1_1_0+I_1_1_1_1)./16;	% nA 


Ibtb_nand_and(counter_mod_index, counter_tech_index,i)=Inand4_cmos_btb(counter_mod_index, counter_tech_index,i);

MULTIVDD=[Vdd(counter_tech_index), VDD2]; % V 
% Power supply Vector

Pnand4_btb(counter_mod_index,counter_tech_index,i)=0;

for j=1:length(MULTIVDD)
		Pnand4_btb(counter_mod_index,counter_tech_index,i)=Pnand4_btb(counter_mod_index,counter_tech_index,i)+Inand4_cmos_btb(counter_mod_index,counter_tech_index,i).*MULTIVDD(j).*1e-9; % W
...
Igate_n_cmos4=Igate_nmos.*Wn;    % nA
Igate_p_cmos4=Igate_pmos.*Wp;    % nA
  		
I_0_0_0_0=4.*Igate_p_cmos4;			% nA
I_0_0_0_1=Igate_n_cmos4+3.*Igate_p_cmos4;	% nA
I_0_0_1_0=3.*Igate_p_cmos4;			% nA
I_0_0_1_1=2.*Igate_n_cmos4+2.*Igate_p_cmos4;	% nA
I_0_1_0_0=3.*Igate_p_cmos4;			% nA
I_0_1_0_1=Igate_n_cmos4+2.*Igate_p_cmos4;	% nA
I_0_1_1_0=2.*Igate_p_cmos4;			% nA
I_0_1_1_1=3.*Igate_n_cmos4+Igate_p_cmos4;	% nA
I_1_0_0_0=3.*Igate_p_cmos4;			% nA
I_1_0_0_1=Igate_n_cmos4+2.*Igate_p_cmos4;	% nA
I_1_0_1_0=2.*Igate_p_cmos4;			% nA
I_1_0_1_1=2.*Igate_n_cmos4+Igate_p_cmos4;	% nA
I_1_1_0_0=2.*Igate_p_cmos4;			% nA
I_1_1_0_1=Igate_n_cmos4+Igate_p_cmos4;		% nA
I_1_1_1_0=Igate_p_cmos4;			% nA
I_1_1_1_1=4.*Igate_n_cmos4;			% nA

Inand4_cmos_gate(counter_mod_index, counter_tech_index, i)=(I_0_0_0_0+I_0_0_0_1+I_0_0_1_0+I_0_0_1_1+I_0_1_0_0+I_0_1_0_1+I_0_1_1_0+I_0_1_1_1+I_1_0_0_0+I_1_0_0_1+I_1_0_1_0+I_1_0_1_0+I_1_0_1_1+I_1_1_0_0+I_1_1_0_1+I_1_1_1_0+I_1_1_1_1)./16;	% nA 

Igate_nand_and(counter_mod_index, counter_tech_index,i)=Inand4_cmos_gate(counter_mod_index, counter_tech_index,i) ;

MULTIVDD=[Vdd(counter_tech_index), VDD2]; % V 
% Power supply Vector

Pnand4_gate(counter_mod_index,counter_tech_index,i)=0;

for j=1:length(MULTIVDD)
		Pnand4_gate(counter_mod_index,counter_tech_index,i)=Pnand4_gate(counter_mod_index,counter_tech_index,i)+Inand4_cmos_gate(counter_mod_index,counter_tech_index,i).*MULTIVDD(j).*1e-9; % W
...
Ioff_n_cmos4=Ioff_nmos_1.*Wn;      % nA
Ioff2_n_cmos4=Ioff_nmos_2.*Wn;   % nA
Ioff3_n_cmos4=Ioff_nmos_3.*Wn;   % nA
Ioff4_n_cmos4=Ioff_nmos_4.*Wn;   % nA
Ioff_p_cmos4=Ioff_pmos.*Wp;      % nA
  		
I_0_0_0_0=Ioff4_n_cmos4;	% nA
I_0_0_0_1=Ioff3_n_cmos4;	% nA
I_0_0_1_0=Ioff3_n_cmos4;	% nA
I_0_0_1_1=Ioff2_n_cmos4;	% nA
I_0_1_0_0=Ioff3_n_cmos4;	% nA
I_0_1_0_1=Ioff2_n_cmos4;	% nA
I_0_1_1_0=Ioff2_n_cmos4;	% nA
I_0_1_1_1=Ioff_n_cmos4;		% nA
I_1_0_0_0=Ioff3_n_cmos4;	% nA
I_1_0_0_1=Ioff2_n_cmos4;	% nA
I_1_0_1_0=Ioff2_n_cmos4;	% nA
I_1_0_1_1=Ioff_n_cmos4;		% nA
I_1_1_0_0=Ioff2_n_cmos4;	% nA
I_1_1_0_1=Ioff_n_cmos4;		% nA
I_1_1_1_0=Ioff_n_cmos4;		% nA
I_1_1_1_1=4.*Ioff_p_cmos4;	% nA

Inand4_cmos_off(counter_mod_index, counter_tech_index, i)=(I_0_0_0_0+I_0_0_0_1+I_0_0_1_0+I_0_0_1_1+I_0_1_0_0+I_0_1_0_1+I_0_1_1_0+I_0_1_1_1+I_1_0_0_0+I_1_0_0_1+I_1_0_1_0+I_1_0_1_0+I_1_0_1_1+I_1_1_0_0+I_1_1_0_1+I_1_1_1_0+I_1_1_1_1)./16;	% nA 

Ioff_nand_and(counter_mod_index, counter_tech_index,i)=Inand4_cmos_off(counter_mod_index, counter_tech_index,i);

MULTIVDD=[Vdd(counter_tech_index), VDD2]; % V 
% Power supply Vector

Pnand4_off(counter_mod_index,counter_tech_index,i)=0;

for j=1:length(MULTIVDD)
		Pnand4_off(counter_mod_index,counter_tech_index,i)=Pnand4_off(counter_mod_index,counter_tech_index,i)+Inand4_cmos_off(counter_mod_index,counter_tech_index,i).*MULTIVDD(j).*1e-9; % W 

endfor

endfor

% POWER STATIC CMOS nand4 

% Vdd_d is the distribution of Vdd in multi-supply voltage chip
% Vdd_d and VDD2 ---> datibase.m

Pnand4(counter_mod_index,counter_tech_index,:)=Pnand4_off(counter_mod_index,counter_tech_index,:)+Pnand4_gate(counter_mod_index,counter_tech_index,:)+Pnand4_btb(counter_mod_index,counter_tech_index,:); % W

Pnand_and(counter_mod_index,counter_tech_index,:)=Pnand4(counter_mod_index,counter_tech_index,:);

% POWER DYNAMIC CMOS NAND4 

for i=1:4

	Pnand4_dyn(counter_mod_index,counter_tech_index,i)=0;
	for j=1:length(MULTIVDD)
			Pnand4_dyn(counter_mod_index,counter_tech_index,i)=Pnand4_dyn(counter_mod_index,counter_tech_index,i)+(Cnand4_cmos(counter_mod_index,counter_tech_index,i).*1e-12).*Vdd_d(j).*MULTIVDD(j).^2.*freq(counter_mod_index,counter_tech_index).*1e6; % W 
	endfor

endfor

Pnand_and_dyn(counter_mod_index,counter_tech_index,:)=Pnand4_dyn(counter_mod_index,counter_tech_index,:);
