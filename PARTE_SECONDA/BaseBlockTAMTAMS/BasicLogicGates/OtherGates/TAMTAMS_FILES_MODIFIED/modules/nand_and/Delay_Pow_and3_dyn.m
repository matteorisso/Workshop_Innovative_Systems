...
C_tot=(C_ox_n*const+2*Coverlap_n)*(alfa_a+alfa_b+alfa_c)+C_M*alfa_M+C_X*(alfa_x1+alfa_x2+alfa_x3)+C_Y*alfa_Y+(C_in)*alfa_clk;  %pF    
...
%---STATIC POWER
static_power = Vdd*0.0625*(9*Ioff_pmos+2*Igate_pmos+33*Ioff_nmos+68*Igate_nmos)*1e-9;	%W
