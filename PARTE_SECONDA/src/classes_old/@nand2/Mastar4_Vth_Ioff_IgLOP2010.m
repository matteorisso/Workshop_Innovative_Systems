function [Vth_n,Vth_p, Ioff_n, Ioff_p, Igate_n, Igate_p]= Mastar4_Vth_Ioff_IgLOP2010()
...
%Geometrical parameters (LOP 2010)
Lgate =22; %nm, The effective length of the gate.
Xj = 7.5; %nm, Source/Drain extensions length.
...
Darks = 0.32; %nm, 2.5 A=0.1nm Dark space length, used in...
...
%Electrical parameters (LOP 2010)
rconst_n = 193.39; %Ohm, N-MOS access resistance, fitting from Mastar output values
rconst_p = 193.39; %Ohm, P-MOS access resistance, same value of N-MOS for now
Fring_cap = 2.2e-16; %F/um, Fringe capacitance per unit length
...
%Power supply parameters (LOP 2010)
Vdd = 0.7; %V Operation voltage (gate and drain voltages)

%Other parameters(LOP 2010)
Cpoches = 5.2e13;
Rp = 10; %nm
Delta_rp = 6; %nm
Delta_rl = 3; %nm
