...
C_tot=(C_ox_n*2+2*Coverlap_n)*(alfa_a+alfa_b+alfa_c)+C_M*alfa_M+C_X*(alfa_x1)+C_Y*alfa_Y+(C_in)*alfa_clk;  %pF    
...
%---STATIC POWER
static_power = Vdd*0.0625*(9*Ioff_pmos+8*Igate_pmos+11*Ioff_nmos+42*Igate_nmos)*1e-9;	%W
