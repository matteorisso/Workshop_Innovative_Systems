...
C_X = const*Cjp; %pF
C_tot=C_in*(alfa_a+alfa_b+alfa_c+alfa_d)+C_M*alfa_M+C_X*(alfa_x1+alfa_x2+alfa_x3);  %pF     % tiene già conto della switching activity
...
%---STATIC POWER
static_power = Vdd*0.0625*(60*Ioff_pmos+60*Igate_pmos+4*Ioff_nmos+32*Igate_nmos)*1e-9;	%W
