...
$tox       =1.5;       //nm           Physical Gate Oxide Thickness 
$nbulk     =4.98e18;  //cm^-3        Channel Doping (w/o Pockets)             
...
$rconst_n  =218.75;    //Ohm        These values are simply the result from a fitting of Mastar's outputs. 
$rconst_p  =218.75;    // NON SICURO: stesso valore di rconst_n Ohm        We need to have a more accurate model for resist)ance (Kim's one in Mastar
...
$phi_s     =1.85; 		// valore calcolato con phi_compute.m         
