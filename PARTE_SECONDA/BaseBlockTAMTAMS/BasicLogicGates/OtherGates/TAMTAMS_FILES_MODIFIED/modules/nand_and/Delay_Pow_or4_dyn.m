...
C_tot=(C_ox_n*2+2*Coverlap_n)*(alfa_a+alfa_b+alfa_c+alfa_d)+C_M*alfa_M+C_X*(alfa_x1)+C_Y*alfa_Y+(C_in)*alfa_clk;  %pF 
...
%---STATIC POWER
static_power= Vdd*0.03125*(17*Ioff_pmos+16*Igate_pmos+19*Ioff_nmos+98*Igate_nmos)*1e-9;	%W
