...
$model     =0;         //BULK         Type
$year      =2005;      //             Year
$lgate     =45.1;        //nm           Physical Gate Length 
...
$nbulk     =2.92e18;  //cm^-3        Channel Doping (w/o Pockets)             
...
$rconst_n  =213.92;    //Ohm        These values are simply the result from a fitting of Mastar's outputs. 
$rconst_p  =213.92;    // NON SICURO: stesso valore di rconst_n Ohm        We need to have a more accurate model for resist)ance (Kim's one in Mastar
...
$phi_s	   =1.814;     // valore calcolato con phi_compute.m     
