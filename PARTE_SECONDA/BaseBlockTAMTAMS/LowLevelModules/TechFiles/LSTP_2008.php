...
$model     =0;         //BULK         Type
$year      =2008;      //             Year
$lgate     =37;        //nm           Physical Gate Length 
...
$tox       =1.6;       //nm           Physical Gate Oxide Thickness 
$nbulk     =4.65e18;  //cm^-3        Channel Doping (w/o Pockets)             
...
$rconst_n  =191.39;    //Ohm        These values are simply the result from a fitting of Mastar's outputs. 
$rconst_p  =191.39;    // NON SICURO: stesso valore di rconst_n Ohm        We need to have a more accurate model for resist)ance (Kim's one in Mastar
...
$phi_s     =1.89; 		// valore calcolato con phi_compute.m        
