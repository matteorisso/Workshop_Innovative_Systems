...
$model     =0;         //BULK         Type
$year      =2007;      //             Year
$lgate     =32.1;        //nm           Physical Gate Length 
...
$nbulk     =4.23e18;  //cm^-3        Channel Doping (w/o Pockets)             
$nd        =1e20;      //cm^-3        drogaggio polisilicio n+
$next	   =7.819e18;// NON SICUR0: non trovato in MASTAR; stesso valore di HP_2007 cm^-3	  drogaggio delle estensioni	
...
$polyd     =3;         //[Å = 0.1nm]  Extension of the poly-depletion (in EOT) 
...
$rconst_n  =206.25;    //Ohm        These values are simply the result from a fitting of Mastar's outputs. 
$rconst_p  =206.25;    // NON SICUR0: stesso valore di rconst_n Ohm        We need to have a more accurate model for resist)ance (Kim's one in Mastar

$tbox	   =20; 		//nm Buried Oxide Thickness
$tsi        =7.6;        //nm
$ngp	   =1e20; 		//cm^-3 Ground Plain doping level

$x         =0; 	// NON SICUR0: non trovato in MASTAR stesso valore HP_2007
$cpoches   =5.2e13;    //at/cm²
$angle     =25;        //°            Pocket Implantation Angle 
$rp        =10;        // NON SICUR0: non trovato in MASTAR nm
$delta_rp  =6;         // NON SICUR0: valore di HP_2007
$delta_rl  =3;         // NON SICUR0: valore di HP_2007 nm
$activepkt =0;			// NON SICUR0: valore di HP_2007
$wt        =1000;      //nm           Width       
$phi_m     =4.05;      //eV          lavoro estrazione polisilicio little bit higher than 4.05 because polysilicon is highly doped; (NON é lo stesso PER NMOS e PMOS)!!!!    // 4.05 originally, modified in 4.15 has in the previous files  
...
$phi_s	   =1.91;     // valore calcolato con phi_compute.m       
...
$sigma     =1;  // NON SICUR0: valore di HP_2007
$ig_improve=1;  // NON SICUR0: valore di HP_2007
