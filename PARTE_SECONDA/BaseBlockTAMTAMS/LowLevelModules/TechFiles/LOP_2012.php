...
$model     =0;         //BULK         Type
$year      =2012;      //             Year
$lgate     =18;        //nm           Physical Gate Length 
...
$ldraw     =35;        // NON SICUR0: valore di HP_2007
$tox       =0.9;       //nm           Physical Gate Oxide Thickness     0.8 originally, modified in 0.9 has in the previous files  
$nbulk     =5.67e18;  //cm^-3        Channel Doping (w/o Pockets)             
$nd        =1e20;      //cm^-3        drogaggio polisilicio n+
$next	   =7.819e18;// NON SICUR0: valore di HP_2007 cm^-3	  drogaggio delle estensioni
$nc        =1e20;      //cm^-3        source/drain doping - non sono sicuro che il valore sia corretto
$xj        =4.8;        //nm				// 9 originally, modified in 8.5 has in the previous files  
$vdd       =0.7;       //V            Operation Voltage (Gate and Drain Voltage) 
...
$rconst_n  =225.49;    //Ohm        These values are simply the result from a fitting of Mastar's outputs. 
$rconst_p  =225.49;    // NON SICUR0: valore di rconst_n Ohm        We need to have a more accurate model for resist)ance (Kim's one in Mastar

$tbox	   =20; 		//nm Buried Oxide Thickness
$tsi        =7.6;        //nm
$ngp	   =1e20; 		//cm^-3 Ground Plain doping level

$x         =0; 			// NON SICUR0: valore di HP_2007
$cpoches   =5.2e13;    //at/cm²
$angle     =25;        //°            Pocket Implantation Angle 
$rp        =10;        // NON SICUR0: valore di HP_2007 nm
$delta_rp  =6;         // NON SICUR0: valore di HP_2007 nm
$delta_rl  =3;         // NON SICUR0: valore di HP_2007 nm
$activepkt =0;			// NON SICUR0: valore di HP_2007
$wt        =1000;      //nm           Width       
$phi_m     =4.15;      //eV          lavoro estrazione polisilicio little bit higher than 4.05 because polysilicon is highly doped; (NON é lo stesso PER NMOS e PMOS)!!!!		4.25 originally, modified in 4.2 has in the previous files  
...
$sigma     =1; // NON SICUR0: valore precedente
$ig_improve=1; // NON SICUR0: valore precedente
