...
$model     =0;         //BULK         Type
$year      =2006;      //             Year
$lgate     =37.1;        //nm           Physical Gate Length 
...
$tox       =1.3;       //nm           Physical Gate Oxide Thickness 
$nbulk     =3.92e18;  //cm^-3        Channel Doping (w/o Pockets)             
...
$xj        =16;        //nm
$vdd       =0.9;       //V            Operation Voltage (Gate and Drain Voltage) 
$darks     =3.4;         //[Å = 0.1nm]  Extension of the Dark Space (in EOT). 
$polyd     =3.1;         //[Å = 0.1nm]  Extension of the poly-depletion (in EOT)
...
$rconst_n  =208.27;    //Ohm        These values are simply the result from a fitting of Mastar's outputs. 
$rconst_p  =208.27;    // NON SICURO: stesso valore di rconst_n Ohm        We need to have a more accurate model for resist)ance (Kim's one in Mastar
...
$phi_s	   =1.872;     // valore calcolato con phi_compute.m        
...
$ig_improve=1; // NON SICURO: stesso valore di LOP_2007 non avendolo trovato in MASTAR
