...
$tox       =1;       //nm           Physical Gate Oxide Thickness 
$nbulk     =4.8e18;  //cm^-3        Channel Doping (w/o Pockets)             
...
$rconst_n  =184.84;    //Ohm        These values are simply the result from a fitting of Mastar's outputs. 
$rconst_p  =184.84;    // NON SICURO: stesso valore di rconst_n Ohm        We need to have a more accurate model for resist)ance (Kim's one in Mastar
...
$phi_s	   =1.859;     // valore calcolato con phi_compute.m      
