...
$model     =0;         //BULK         Type
$year      =2012;      //             Year
$lgate     =22;        //nm           Physical Gate Length 
...
$tox       =1.3;       //nm           Physical Gate Oxide Thickness   2.2 originally, reduced to 1.2 looking at the scaling between LSTP_2010 and LSTP_2012
$nbulk     =6.3e18;  //cm^-3        Channel Doping (w/o Pockets)             
...
$darks     =3.1;         //[Å = 0.1nm]  Extension of the Dark Space (in EOT). 
...
$rconst_n  =238.32;    //Ohm        These values are simply the result from a fitting of Mastar's outputs. 
$rconst_p  =238.32;    // NON SICURO: valore di rconst_n Ohm        We need to have a more accurate model for resist)ance (Kim's one in Mastar
...
$wt        =1000;      //nm           Width       
$phi_m     =4.15;      //eV          lavoro estrazione polisilicio little bit higher than 4.05 because polysilicon is highly doped; (NON é lo stesso PER NMOS e PMOS)!!!! 		// 4.25 originally, modified in 4.1 has in the previous files  
...
$phi_s     =1.956; 		// valore calcolato con phi_compute.m        
