%% PASS-TRANSISTOR AND 3 POWER ANALYSIS
% Implementation of a model for the evaluation of power consumption of 3 inputs PASS-TRANSISTOR NAND-AND gates
%%
...
% Module name: I_Pow_Pass_Transistor_and3.m
% Stored informations:  Iand3_pass_btb, Iand3_pass_gate, Iand3_pass_off, Pand3, Pand3_dyn
...
Ibtb_n_pass3=Ibtb_nmos.*Wn;      % nA
Ibtb_p_pass3=Ibtb_pmos.*Wp;      % nA

I_0_0_0=2.*Ibtb_n_pass3+8.*Ibtb_p_pass3;	%nA
I_0_0_1=Ibtb_n_pass3+9.*Ibtb_p_pass3;		%nA
I_0_1_0=Ibtb_n_pass3+9.*Ibtb_p_pass3;		%nA
I_0_1_1=10.*Ibtb_p_pass3;			%nA
I_1_0_0=3.*Ibtb_n_pass3+7.*Ibtb_p_pass3;	%nA
I_1_0_1=2.*Ibtb_n_pass3+8.*Ibtb_p_pass3;	%nA
I_1_1_0=5.*(Ibtb_n_pass3+Ibtb_p_pass3);		%nA
I_1_1_1=2.*(2.*Ibtb_p_pass3+3.*Ibtb_n_pass3);	%nA

Iand3_pass_btb(counter_mod_index, counter_tech_index, i)=(I_0_0_0+I_0_0_1+I_0_1_0+I_0_1_1+I_1_0_0+I_1_0_1+I_1_1_0+I_1_1_1)./8;	%nA

Ibtb_nand_and(counter_mod_index, counter_tech_index,i)=Iand3_pass_btb(counter_mod_index, counter_tech_index,i);
...
for j=1:length(MULTIVDD)
		Pand3_btb(counter_mod_index,counter_tech_index,i)=Pand3_btb(counter_mod_index,counter_tech_index,i)+Iand3_pass_btb(counter_mod_index,counter_tech_index,i).*MULTIVDD(j).*1e-9; % W
...
Igate_n_pass3=Igate_nmos.*Wn;    % nA
Igate_p_pass3=Igate_pmos.*Wp;    % nA

I_0_0_0=2.*(2.*Igate_p_pass3+Igate_n_pass3);		%nA
I_0_0_1=3.*(Igate_n_pass3+Igate_p_pass3);	%nA
I_0_1_0=3.*(Igate_n_pass3+Igate_p_pass3);	%nA
I_0_1_1=2.*(2.*Igate_n_pass3+Igate_p_pass3);		%nA
I_1_0_0=2.*Igate_n_pass3+3.*Igate_p_pass3;	%nA
I_1_0_1=3.*Igate_n_pass3+2.*Igate_p_pass3;	%nA
I_1_1_0=2.*(Igate_p_pass3+Igate_n_pass3);	%nA
I_1_1_1=2.*(Igate_n_pass3+Igate_p_pass3);	%nA 

Iand3_pass_gate(counter_mod_index, counter_tech_index, i)=(I_0_0_0+I_0_0_1+I_0_1_0+I_0_1_1+I_1_0_0+I_1_0_1+I_1_1_0+I_1_1_1)./8;	%nA

Igate_nand_and(counter_mod_index, counter_tech_index,i)=Iand3_pass_gate(counter_mod_index, counter_tech_index,i) ;
...
for j=1:length(MULTIVDD)
		Pand3_gate(counter_mod_index,counter_tech_index,i)=Pand3_gate(counter_mod_index,counter_tech_index,i)+Iand3_pass_gate(counter_mod_index,counter_tech_index,i).*MULTIVDD(j).*1e-9; % W
...
Ioff_n_pass3=Ioff_nmos.*Wn;      % nA
Ioff_p_pass3=Ioff_pmos.*Wp;      % nA

I_0_0_0=2.*Ioff_n_pass3;		%nA
I_0_0_1=Ioff_n_pass3+Ioff_p_pass3;	%nA
I_0_1_0=Ioff_n_pass3+Ioff_p_pass3;	%nA
I_0_1_1=2.*Ioff_p_pass3;		%nA
I_1_0_0=2.*Ioff_n_pass3+Ioff_p_pass3;	%nA
I_1_0_1=Ioff_n_pass3+3.*Ioff_p_pass3;	%nA
I_1_1_0=2.*(Ioff_n_pass3+Ioff_p_pass3);	%nA
I_1_1_1=2.*(Ioff_p_pass3+Ioff_n_pass3);	%nA 

Iand3_pass_off(counter_mod_index, counter_tech_index, i)=(I_0_0_0+I_0_0_1+I_0_1_0+I_0_1_1+I_1_0_0+I_1_0_1+I_1_1_0+I_1_1_1)./8;	%nA

Ioff_nand_and(counter_mod_index, counter_tech_index,i)=Iand3_pass_off(counter_mod_index, counter_tech_index,i);
...
for j=1:length(MULTIVDD)
		Pand3_off(counter_mod_index,counter_tech_index,i)=Pand3_off(counter_mod_index,counter_tech_index,i)+Iand3_pass_off(counter_mod_index,counter_tech_index,i).*MULTIVDD(j).*1e-9; % W 

endfor

endfor

% POWER Pass Transistor and3 
...
% POWER DYNAMIC Pass Transistor AND3 

for i=1:4

	Pand3_dyn(counter_mod_index,counter_tech_index,i)=0;
	for j=1:length(MULTIVDD)
			Pand3_dyn(counter_mod_index,counter_tech_index,i)=Pand3_dyn(counter_mod_index,counter_tech_index,i)+(Cand3_pass(counter_mod_index,counter_tech_index,i).*1e-12).*Vdd_d(j).*MULTIVDD(j).^2.*freq(counter_mod_index,counter_tech_index).*1e6; % W 
	endfor
